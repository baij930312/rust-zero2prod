...
pub fn get_configuration() -> Result<Settings, config::ConfigError> {
    ...
    let ebvironment: Environment = std::env::var("APP_ENVIROMENT")
        .unwrap_or_else(|_| "local".into())
        .try_into()
        .expect("Failded to parse APP_ENVIROMENT");
    let configuration_filename = format!("{}.yaml", ebvironment.as_str());
